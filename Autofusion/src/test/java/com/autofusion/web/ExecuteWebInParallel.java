...
public class ExecuteWebInParallel implements Runnable{
	...
	public static void main(String args[]) {
		ExecuteWebInParallel obj = new ExecuteWebInParallel();
		
		//obj.createThread("C:\\Nitin\\AutofusionRepositorySprint","web","local","SprintLoginSuite","RTB","chrome", "keyword", "3");
