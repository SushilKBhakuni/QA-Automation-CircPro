  ...
  <div class="loginlayout">
    ...
    <form method="post" action="Login" name="indexForm" class="loginfrm">
        ...
        <div class="frmgroup">
          ...
          <input type="text" name="userName" id="userName" value="admin" class="span6 input-medium">
        </div>
        <div class="frmgroup">
          <label>Password</label>
          <input id="password" class="span6 input-medium" type="text" name="password" value="admin" >	
        </div>
        <div class="frmgroup">
          <label>Project</label>
