  ...
  <div class="layout">
     ...
     <div class="whitebg blockelement padding15" id="home">
     	<ul class="progressbar">
		     	...
		     	<li class="active"><span class="icon"></span><span class="titletxt"><a href="addTestCases1.jsp">Create test case</a></span>
	    ...
	    <div class="fullwidth"  >
	 		<form method="post" action="AddTestCase" class="innerformsection" name="addTestCaseForm" id="addTestCaseForm">
				...
				<div class="fullwidth innerbtmrow">
			 		<div class="padding30 fl width90">
						...
						<label class="labeltxt">Application</label> <select
							name="device" id="device" class="width230" onchange="getSuiteList('addTestCaseForm','selSuite')">
					...
					<div class="frmrow marginbtm20">
						<label class="labeltxt">Select Suite</label> 
						<select name='selSuite' id='selSuite' class='width230'></select>
						
				   </div>
					<div class="frmrow marginbtm20">
						<label class="labeltxt">Test Case Name</label> 
						<input type="text" name="description" id="description" class="span6 input-medium" >
					</div>
					<!-- div class="frmrow marginbtm20">
						<label class='labeltxt2'>Data Driven</label>
						<label class='checkbox'>
					    <input type='checkbox'  name='chkDataDriven' id='chkDataDriven' value='Y'></label>
					</div>
					<div class="frmrow marginbtm20">    
		      		 ...
		      		 <input type="button" class="button marginnone" name="btnAddTestCase" id="btnAddTestCase" value="Add Test Case" onclick="funcAddTestCases('addTestCaseForm','AddTestCase','Test Case')"></div>
		    	</div>
		    	
		    	<input type="hidden" name="selectedTab" id="selectedTab" value="AddTestCase">
		    	</form>
		    </div>
